...
| …and friends/PEX immediately | NOW ENFORCED against peers who have learned the revocation — friend/PEX verifiers consult the live revoked-device projection; friends get a RevocationPush at revoke time; new friends learn at link time via carried revocations (ZEB-680). Stranger residual: a device linking with a total stranger who shares no community and has heard nothing still succeeds | Retired by ZEB-680 — dialog copy states the cutoff + the stranger residual |
