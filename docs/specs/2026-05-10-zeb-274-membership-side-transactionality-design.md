...
- Production wiring (target): `community_state_sync.rs::CommunitySyncRegistry::spawn_engine` (line 2442) + `lib.rs::create_community_inner` (line 7193) + `lib.rs::redeem_invite_inner` (line 8420)
