...
const EXPECTED_FRIEND_ENTRY_WITH_SECRET_HEX: &str = "";
...
fn friend_entry_with_secret_canonical_cbor() {
    ...
    // Structural: "k" must be present as a non-empty sequence (Vec<u8> encodes
    // via ciborium as a CBOR array of integers — major type 4).
    let k_val = map
        .iter()
    ...
    assert!(
        k_val.as_array().is_some(),
        "\"k\" (sealed_secret) must encode as a CBOR array (Vec<u8>), got: {k_val:?}"
    );
    assert!(
        !k_val.as_array().unwrap().is_empty(),
        "\"k\" must encode a non-empty byte sequence"
    );
}
