...
// structs moved to single-char keys (a/n/t/e/c/s). ZEB-461 re-pinned again:
// both gained the device bundle (d=sender_devices / p=device_identity_pubs),
// reachability (i=iroh_node_id bstr32 / r=home_relay_url) and PQ keys
// (q=pq_dsa_pubkey / k=pq_kem_pubkey). Fixtures pin all six to EMPTY defaults,
// so the new keys encode as empty array / null / zero-bstr32 / empty bstr.
// eph is pinned to [0x55; 32] so the bytes stay deterministic. Re-pinned via
// the FILL_AFTER regen-on-first-run sentinel.
const EXPECTED_FRIEND_LINK_REQUEST_HEX: &str = "";
const EXPECTED_FRIEND_LINK_ACCEPTED_HEX: &str = "";
...
const EXPECTED_FRIEND_LINK_RESPONSE_ACCEPTED_HEX: &str = "";
...
fn friend_link_request_cbor() {
    ...
    let req = FriendLinkRequest {
        ...
        // keys (d/p/i/r/q/k) still encode (no skip_serializing_if), so the hex
        // and structural key set below grow accordingly.
        sender_devices: vec![],
    ...
    // t (token_sig) / e (eph_x25519_pub) / c (enrollment) / s (sig); ZEB-461
    // adds d (sender_devices) / p (device_identity_pubs) / i (iroh_node_id) /
    // r (home_relay_url) / q (pq_dsa_pubkey) / k (pq_kem_pubkey).
    let value: ciborium::Value = ciborium::de::from_reader(&encoded[..]).expect("decode as value");
    let map = value.as_map().expect("FriendLinkRequest is a CBOR map");
    let keys: Vec<&str> = map.iter().filter_map(|(k, _)| k.as_text()).collect();
    for k in ["a", "n", "t", "e", "c", "s", "d", "p", "i", "r", "q", "k"] {
        assert!(keys.contains(&k), "FriendLinkRequest missing \"{k}\" key");
    }
    assert_eq!(
        map.len(),
        12,
        "FriendLinkRequest should encode 12 keys (display + token_sig + ZEB-461 bundle present)"
    );
}
...
fn friend_link_accepted_cbor() {
    ...
    // Structural: ZEB-371 single-char renames → a (from_addr) / n (display) /
    // e (eph_x25519_pub) / c (enrollment) / s (sig); ZEB-461 adds d/p/i/r/q/k.
    let value: ciborium::Value = ciborium::de::from_reader(&encoded[..]).expect("decode as value");
    let map = value.as_map().expect("FriendLinkAccepted is a CBOR map");
    let keys: Vec<&str> = map.iter().filter_map(|(k, _)| k.as_text()).collect();
    for k in ["a", "n", "e", "c", "s", "d", "p", "i", "r", "q", "k"] {
        assert!(keys.contains(&k), "FriendLinkAccepted missing \"{k}\" key");
    }
    assert_eq!(
        map.len(),
        11,
        "FriendLinkAccepted should encode 11 keys (display + ZEB-461 bundle present)"
    );
}
